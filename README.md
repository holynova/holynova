...
# 作品列表/demo地址
1. 翻阅经典, 与一个惊艳的名字不期而遇: 古诗文起名 http://xiaosang.net/gushi_namer/
...
2. 强迫症福利:等宽文字生成器 http://xiaosang.net/equal_width/
...
3. 刘庸干净又卫生: 弹幕附魔 http://xiaosang.net/string_alchemy/
...
4.排序算法可视化 http://xiaosang.net/algorithm/show_sort/index.html
...
5.藏头诗生成器 http://xiaosang.net/head_tail_poem/
