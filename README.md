...
### 📖 快速导航
1. [古诗文起名](#古诗文起名)
2. [Gemini 批量生图插件](#gemini-批量生图插件)
3. [Scrape to Markdown](#scrape-to-markdown)
4. [坦克战术](#坦克战术)
5. [俳句Tinder](#俳句tinder)
6. [YouTube视频抓取](#youtube视频抓取)
7. [收藏夹淘金](#收藏夹淘金)
8. [等宽文字生成器](#等宽文字生成器)
9. [弹幕附魔](#弹幕附魔)
10. [排序算法可视化](#排序算法可视化)
...
- **简介**: 一个多功能 Chrome 扩展，用于内容抓取、格式转换 and 批量图片下载
